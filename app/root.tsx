...
export const meta: MetaFunction = () => {
  return {
    title: "Wedding - Joseph & Brittany Vasconcelos",
    description:
      "Friday, November 10, 2023, Loon Pond Lodge",
    "og:image:type": "image/jpeg",
    "og:site_name": "Wedding - Joseph & Brittany Vasconcelos",
    "og:url": "https://josephbrittany.com",
    "og:title": "Wedding - Joseph & Brittany Vasconcelos",
    "og:description": ``,
    "og:type": "website",
